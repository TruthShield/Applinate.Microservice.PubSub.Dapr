...
{
    static string Version = new Version(0, 1, 0).ToString() + "-beta";
    ...
    Target Pack => _ => _
      ...
      {
          DotNetPack(s => s
            .SetProject(Solution.GetProject("Applinate.Microservice.PubSub.Abstractions"))
            .SetConfiguration(Configuration)
            .EnableNoBuild()
            .EnableNoRestore()
            .SetVersion(Version)
          ...
          DotNetPack(s => s
            .SetProject(Solution.GetProject("Applinate.Microservice.PubSub.Dapr.Publisher"))
            .SetConfiguration(Configuration)
            .EnableNoBuild()
            .EnableNoRestore()
            .SetVersion(Version)
          ...
          DotNetPack(s => s
           .SetProject(Solution.GetProject("Applinate.Microservice.PubSub.Dapr.Subscriber"))
           .SetConfiguration(Configuration)
           .EnableNoBuild()
           .EnableNoRestore()
           .SetVersion(Version)
